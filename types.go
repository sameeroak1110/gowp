...
type WorkerPool struct {
	...
	startMsg string               // indicates the wp has been started.
	cancelMsg string              // indicates the wp has been cancelled/stopped.
	ctx context.Context           // passed on from upstream.
